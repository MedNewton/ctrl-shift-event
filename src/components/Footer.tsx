...
export function Footer() {
  return (
    <footer className="py-20 px-4 md:px-6 border-t border-[rgba(255,255,255,0.5)] bg-[rgba(6,6,6,0)]">
      <div className="container mx-auto max-w-5xl">
        <div className="grid grid-cols-2 md:flex md:justify-between gap-8 text-left w-full">
          <div>
            <h4 className="font-bold mb-4 text-sm uppercase text-[rgb(220,184,33)]">
              About us
            </h4>
